    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='network.networkobject', verbose_name='Cсылка на поставщика')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('network_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='network.networkobject', verbose_name='Объект сети')),
            ],
            options={
